...
import com.example.pollseb.security.CurrentUser;
import com.example.pollseb.security.UserPrincipal;
import com.example.pollseb.service.PollService;
...
public class PollController {
    ...
    @DeleteMapping
    @PreAuthorize("hasRole('USER')")
    public ResponseEntity<?> deletePoll(@Valid @RequestBody PollResponse pollResponse) {
        Poll poll = pollService.deletePoll(pollResponse);
